...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[LE]{\numberparfalse\small\itshape\color{deepblue} Pascha, Not ``Easter''}
\fancyhead[RO]{\numberparfalse\small\itshape\color{deepblue} \leftmark}
\fancyfoot[C]{\numberparfalse\small\thepage}
...
% ── Marginal paragraph numbers (patristic style) ─────────────
\usepackage{etoolbox}
\newcounter{parno}
\newif\ifnumberpar  % false by default

\AddToHook{para/begin}{%
  \ifnumberpar
    \stepcounter{parno}%
    \llap{\scriptsize\color{gold!80!black}\arabic{parno}\enspace}%
  \fi
}

% Suppress numbering on \part title pages
\makeatletter
\pretocmd{\@part}{\numberparfalse}{}{}
\pretocmd{\@endpart}{\numberpartrue}{}{}
\makeatother
...
\vspace*{\fill}
\begin{center}
{\small\itshape Set in Palatino. Winter 2026.\\[4pt]
Offered freely for study and discussion.}
\end{center}
\vspace*{\fill}
\clearpage
...
a Christian festival origin. Phonetic similarity alone is not evidence.
...
biblical system itself. So claims of ``returning'' to the original
...
mutilation for Christ only years earlier. These were men formed in
...
\subsection{1. Late-Antique Rhetoric \& Invective Culture\\{\normalfont\small\itshape (Foundational / Consensus)}}
...
\subsection{2. Anti-Judaism vs Antisemitism\\{\normalfont\small\itshape (Distinction is consensus; interpretation varies)}}
...
\subsection{3. Intra-Christian Polemic \& Rhetorical Violence\\{\normalfont\small\itshape (Consensus)}}
...
\subsection{4. Roman Imperial Rhetoric\\{\normalfont\small\itshape (Non-Christian, very strong evidence)}}
...
\subsection{5. Constantine \& Nicaea\\{\normalfont\small\itshape (Debated, but with clear boundaries)}}
...
\subsection{6. Where Real Debate Actually Exists\\{\normalfont\small\itshape (Important honesty)}}
...
\chapter{A Personal Note from the Author}

\emph{Who am I to care about these things?}
...
he had an encounter with God --- not that systematic theology is useless,
...
{\small\itshape\color{deepblue} Offered freely, Winter 2026.}
